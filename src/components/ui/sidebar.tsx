    ...
    return (
      <aside
        ...
        className={cn(
          ...
          side === "left" && "border-r",
          side === "right" && "border-l",
          variant === 'floating' && 'm-2 h-[calc(100vh-theme(spacing.4))] rounded-lg border',
          variant === 'inset' && 'h-[calc(100vh-theme(spacing.4))]',
          className
        )}
        {...props}
      />
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ...
      className={cn(
        "flex-1",
        "group-data-[variant=inset]/sidebar-wrapper:m-2 group-data-[variant=inset]/sidebar-wrapper:h-[calc(100vh-theme(spacing.4))] group-data-[variant=inset]/sidebar-wrapper:rounded-lg group-data-[variant=inset]/sidebar-wrapper:border",
        className
      )}
      {...props}
    />
