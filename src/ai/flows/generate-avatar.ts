...
/**
 * @fileOverview Generates an avatar image using an AI model.
 *
 * - generateAvatar - A function to generate an avatar.
...
const generateAvatarFlow = ai.defineFlow(
  ...
  async (input) => {
    const { media } = await ai.generate({
      ...
      prompt: `photorealistic avatar, ${input.prompt}, high resolution`,
      config: {
