  ...
  return (
    <div className="container mx-auto px-4 py-4 md:py-8 max-w-4xl">
      <div className="space-y-8">
        ...
        {/* 
          This is the new Client Component. It receives the static topic data as a prop
          and will be responsible for all client-side state and interactivity:
          - Checking if the user has voted
          - Handling the vote action
          - Displaying the correct voting UI (buttons, results, revote)
