...
const subCategoryData = [
    ...
    { id: "municipal_reform", label: "Municipal Reform", categoryId: "elections-governance", topic: "Merge municipalities with <5k residents?", imageUrl: 'https://images.unsplash.com/photo-1598484439943-524831b12b59?q=80&w=1740&auto=format&fit=crop', aiHint: 'norway map', voteType: 'yesno' },
    // Taxation
    ...
    { id: "carbon_tax", label: "Carbon Tax", categoryId: "taxation", topic: "Increase carbon tax to NOK 2,000/ton?", imageUrl: 'https://images.unsplash.com/photo-1611270418597-a6c77f724d6a?q=80&w=1740&auto=format&fit=crop', aiHint: 'factory smoke', voteType: 'quadratic' },
    // Budget & Public Finance
    { id: "fiscal_rule", label: "Fiscal Rule", categoryId: "budget-public-finance", topic: "Change structural non‑oil deficit rule to 2.5%?", imageUrl: 'https://images.unsplash.com/photo-1559526324-c1f275fbfa32?q=80&w=1740&auto=format&fit=crop', aiHint: 'norway flag', voteType: 'yesno' },
    ...
    { id: "industrial", label: "Industrial Policy", categoryId: "economy-business", topic: "Subsidize a national battery gigafactory program?", imageUrl: 'https://images.unsplash.com/photo-1664983830421-4d39f75a6438?q=80&w=1740&auto=format&fit=crop', aiHint: 'battery factory', voteType: 'yesno' },
    // Labor & Welfare
    ...
    // Environment & Energy
    { id: "renewables", label: "Renewables", categoryId: "environment-energy", topic: "Build 5 GW offshore wind by 2030?", imageUrl: 'https://images.unsplash.com/photo-1549993339-447a960f2c4e?q=80&w=1740&auto=format&fit=crop', aiHint: 'wind turbines', voteType: 'yesno' },
    ...
    { id: "nuclear", label: "Nuclear", categoryId: "environment-energy", topic: "Legalize small modular reactors (SMRs)?", imageUrl: 'https://images.unsplash.com/photo-1628178887966-da6a0d6c41b8?q=80&w=1740&auto=format&fit=crop', aiHint: 'nuclear power', voteType: 'yesno' },
    ...
    { id: "public_transit", label: "Public Transit", categoryId: "infrastructure-transport", topic: "Free transit for under‑18s?", imageUrl: 'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?q=80&w=1674&auto=format&fit=crop', aiHint: 'city bus', voteType: 'yesno' },
    ...
    { id: "privacy", label: "Civil Liberties", categoryId: "justice-rights-public-safety", topic: "Ban mass facial recognition in public spaces?", imageUrl: 'https://images.unsplash.com/photo-1550699049-727e5724558e?q=80&w=1740&auto=format&fit=crop', aiHint: 'cctv camera', voteType: 'yesno' },
    ...
    { id: "ai_governance", label: "AI Governance", categoryId: "digital-data-ai", topic: "Adopt Algorithmic Accountability Act?", imageUrl: 'https://images.unsplash.com/photo-1677756119517-756a188d2d94?q=80&w=1740&auto=format&fit=crop', aiHint: 'robot hand', voteType: 'yesno' },
    ...
    { id: "arctic", label: "Arctic Policy", categoryId: "defense-foreign-affairs", topic: "Increase Arctic patrols and infrastructure?", imageUrl: 'https://images.unsplash.com/photo-1549282366-c951082dsadq?q=80&w=1740&auto=format&fit=crop', aiHint: 'icebreaker ship', voteType: 'yesno' },
    ...
    { id: "animal_welfare", label: "Animal Welfare", categoryId: "agriculture-fisheries-rural", topic: "Phase out fur farming?", imageUrl: 'https://images.unsplash.com/photo-1599335619943-441f727a8d42?q=80&w=1740&auto=format&fit=crop', aiHint: 'fox animal', voteType: 'yesno' },
    ...
    { id: "foreign_fishing", label: "Fisheries", categoryId: "agriculture-fisheries-rural", topic: "Foreign fishing boats should be banned from Norwegian waters.", imageUrl: 'https://images.unsplash.com/photo-1655523539874-e6c9aa4b5edd?q=80&w=1080&auto=format&fit=crop', aiHint: 'fishing trawler', voteType: 'yesno' },
    ...
    { id: "media_policy", label: "Media", categoryId: "culture-media-sports", topic: "Expand public broadcaster budget?", imageUrl: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=1744&auto=format&fit=crop', aiHint: 'retro tv', voteType: 'yesno' },
